...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int RC_SIGN_IN=101;//just putted a random number
    SignInButton sign;
   FirebaseAuth mAuth;
  ...
  //mGoogleSignInClient=GoogleSignIn.getClient(this,gso);
    ...
    private void signIn(){
       // Intent signInIntent = mGoogleSignInClient.getSignInIntent();
        Intent signInIntent=Auth.GoogleSignInApi.getSignInIntent(mGooleApiClient);
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                           ...
                           // updateUI(user);
                            ...
                            Toast.makeText(MainActivity.this, "Auth failed", Toast.LENGTH_SHORT).show();                            //updateUI(null);
                        }
